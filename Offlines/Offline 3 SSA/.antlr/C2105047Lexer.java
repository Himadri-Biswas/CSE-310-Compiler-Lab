// Generated from e:/academics repo/CSE 310 repo/Offlines/Offline 3 SSA/C2105047Lexer.g4 by ANTLR 4.13.1
...
public class C2105047Lexer extends Lexer {
	...
	public C2105047Lexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "C2105047Lexer.g4"; }
	...
	private void UNRECOGNIZED_CHAR_action(RuleContext _localctx, int actionIndex) {
		...
		case 34:

			        {
			            ...
			            {
			              errorFile << "Error at line " << getLine() << ": Unrecognized character " << getText() << std::endl << std::endl;
			              errorFile.close();
			            }
			        }
